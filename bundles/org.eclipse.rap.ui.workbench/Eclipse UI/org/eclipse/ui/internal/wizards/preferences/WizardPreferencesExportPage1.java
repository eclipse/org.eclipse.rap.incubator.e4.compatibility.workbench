...
public class WizardPreferencesExportPage1 extends WizardPreferencesPage  {
	...
	protected WizardPreferencesExportPage1(String name) {
		super(name);
		setTitle(PreferencesMessages.get().WizardPreferencesExportPage1_exportTitle);
		setDescription(PreferencesMessages.get().WizardPreferencesExportPage1_exportDescription);
	}
	...
	protected String getAllButtonText() {
		return PreferencesMessages.get().WizardPreferencesExportPage1_all;
	}

	@Override
	protected String getChooseButtonText() {
		return PreferencesMessages.get().WizardPreferencesExportPage1_choose;
	}
	...
	protected String getDestinationLabel() {
		return PreferencesMessages.get().WizardPreferencesExportPage1_file;
	}
	...
	protected String getFileDialogTitle() {
		return PreferencesMessages.get().WizardPreferencesExportPage1_title;
	}
	...
	protected String getInvalidDestinationMessage() {
		return PreferencesMessages.get().WizardPreferencesExportPage1_noPrefFile;
	}
