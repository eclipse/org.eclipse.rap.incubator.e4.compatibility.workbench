...
public class HeapStatus extends Composite {
	...
	public HeapStatus(Composite parent, IPreferenceStore prefStore) {
		...
		canvas.setToolTipText(WorkbenchMessages.get().HeapStatus_buttonToolTip);
...
//        }
    ...
    private String convertToMegString(long numBytes) {
		return NLS.bind(WorkbenchMessages.get().HeapStatus_meg, Long.valueOf(convertToMeg(numBytes)));
    }
